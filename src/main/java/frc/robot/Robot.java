...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    m_colorMatcher.addColorMatch(RobotContainer.kBlackTarget);
  ...
  public void robotPeriodic() {
    ...
    if (match.color == RobotContainer.kBlueTarget) {
      colorString = "Blue";
      BatId = RobotContainer.Bat_Blue_Id;
      ...
      colorString = "Yellow";
    } else if (match.color == RobotContainer.kBlackTarget) {
      colorString = "Black";
    } else {
      colorString = "Unknown";
    }
    ...
    SmartDashboard.putNumber(colorString, kDefaultPeriod)
  }
